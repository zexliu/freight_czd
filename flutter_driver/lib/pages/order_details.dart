                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              ListTile(
                                ...
                                title: Text("${s.data.userName} (${s.data.companyName})"),
                                subtitle: Text(s.data.userMobile),
                                trailing: IconButton(
                                  icon: Icon(Icons.phone),
                                  color: Theme.of(context).primaryColor,
                                  onPressed: () {
                                    PhoneUtils.call(context,s.data.userMobile,
                                        s.data.userId, s.data.deliveryId);
                                  },
                                ),
                              ),
                              SizedBox(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Text(s.data.driverPayStatus ? "已支付" : "未支付"),
                            ],
                          ),
                        )
                      ],
            ...
            child: OutlineButton(
              onPressed: () async {
                ...
                await Navigator.of(context).push(MaterialPageRoute(builder: (c) {
                  ...
                  entity.id = data.id;
                  return PrePayPage(entity,data.freightAmount.toString(),data.amount.toString(),1);
                }));
      ...
      list.add(Expanded(
          child: Padding(
            ...
            child: OutlineButton(
              ...
              child: Text(data.protocolStatus == 1 || data.protocolStatus == 3
                  ? "查看协议"
                  : "签订协议"),
              textColor: Theme.of(context).primaryColor,
              borderSide: new BorderSide(color: Theme.of(context).primaryColor),
