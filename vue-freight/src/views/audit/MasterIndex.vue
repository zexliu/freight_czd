    ...
    >
      ...
      <div slot="expandedRowRender" slot-scope="record" style="margin: 0">
        <a-descriptions title="认证信息">
          ...
          <a-descriptions-item label="营 业 执 照 ">
            <el-image
              style="width: 220px; height: 140px"
          ...
          <a-descriptions-item label="门店人合影">
            <el-image
              style="width: 220px; height: 140px"
              :src="record.shopGroupPhoto"
              :fit="fit"
              :preview-src-list="[
                record.shopGroupPhoto,
                record.identityCard,
...
export default class extends Mixins(MixinTable) {
  subjectTitle = '货主认证'
  subject = 'iFoDeliveryExtension'
  url = '/api/v1/delivery/extension'
  ...
  onAuditClick(id: string, auditStatus: String) {
    ...
    this.formData.targetType = 'USER_AUTHENTICATION'
