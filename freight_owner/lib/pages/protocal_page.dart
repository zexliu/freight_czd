                                        ...
                                        children: <Widget>[
                                          ...
                                          InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              height: 44,
                                              child: Text(
                                                this._loadAddress == "" ? s.data.id == null ? "请输入详细地址": "--" :  this._loadAddress ,
                                                style: TextStyle(
                                                  color: Colors.grey,
                                                ),
                                                maxLines: 1,
                                        ...
                                        children: <Widget>[
                                          ...
                                          InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              height: 44,
                                              child: Text(
                                                this._uploadAddress == "" ? s.data.id == null ? "请输入详细地址": "--" :  this._uploadAddress,
                                                style: TextStyle(
                                                  color: Colors.grey,
                                                ),
                                                maxLines: 1,
                                ...
                                child: Padding(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      contentPadding: EdgeInsets.all(0),
                                      hintText:
                                          s.data.id == null ? "佣金，回单押金;如果选择不在线支付在此处可以补充线下付款方式:禁区;几装几卸等约定" : "",
                                      border: OutlineInputBorder(
                                          borderSide: BorderSide.none),
                                    ),
                                  ),
                      ...
                      Row(
                        children: [
                          Checkbox(
                            ...
                            onChanged: s.data.userAgree ? null : (v) {
                              setState(() {
                                protocolChecked = v;
                              });
                            },
                        ...
                        child: MaterialButton(
                          child: Text(s.data.id == null
                              ...
                              : s.data.driverAgree && s.data.userAgree
                                  ? "已签署"
                                  : s.data.userAgree ? "已提交" : "同意"),
                          color: Theme.of(context).primaryColor,
                          disabledColor: Colors.blueGrey,
                          disabledTextColor: Colors.white,
                          textColor: Colors.white,
                          minWidth: double.infinity,
                          onPressed: s.data.id == null || !s.data.userAgree
                              ? () {
                                  ...
                                  if (s.data.id == null) {
                                    ...
                                    HttpManager.getInstance()
                                        .post("/api/v1/protocols/agree/${s.data.id}")
                                        .then((value) {
                                      Toast.show("提交成功");
                                      _fetchDetails = _fetch();
